...
def rsa_decrypt():
    ...
    try:
        # Chuyển đổi chuỗi Hex nhận được từ API trở lại dạng bytes ban đầu
...
# Bổ sung thêm API Sign (Ký số) nếu ứng dụng của bạn cần dùng
...
# Bổ sung thêm API Verify (Xác thực chữ ký) nếu ứng dụng của bạn cần dùng
...
if __name__ == '__main__':
    # Chạy ứng dụng Flask ở cổng 5000
